...
excerpt: '为什么么我要知道MYSQL安装在哪？最近公司给了台堡垒机服务器，我需要去连接服务器查看MySQL数据库表。因为这个堡垒机只能通过浏览器的远程vpn访问，ssh连接工具都无法使用，只能用它那个浏览器界面了去服务器找Mysql安装在哪才能连接到数据库据库😢。1.whereis/where...'
tags:
- Linux
- MySQL
title: Linux系统查找MYSQL安装路径(排查和解决)
author: FZ688
